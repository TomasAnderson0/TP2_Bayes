...
```{r, echo = FALSE, error = FALSE, message = FALSE, warning = FALSE, fig.align='center'}
...
En la figura x se observa que el método funciona mejor con una concentración alta porque oscila más veces recorriendo la densidad de una manera más eficiente. Esto se verifica observando las tasas de aceptación de los saltos en la tabla 2.


```{r, echo = FALSE, error = FALSE, message = FALSE, warning = FALSE, fig.width=8}
...
```{r, echo = FALSE, error = FALSE, message = FALSE, warning = FALSE, fig.height = 4, fig.width = 7}
